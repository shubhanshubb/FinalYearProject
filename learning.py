...
data = pd.read_csv('Malware_Detection_data.csv', sep='|') #generate df as data
...
X_train, X_test, y_train, y_test = sklearn.model_selection.train_test_split(X_new, y ,test_size=0.2)#now converting in training and testing data in 20% range hahhahaha ! as total x is 138047 and testing is 138047*0.2=27610 :)
features = []
